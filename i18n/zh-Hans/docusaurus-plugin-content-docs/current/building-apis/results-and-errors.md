...
认证、签名、会话、challenge 流相关的错误位于 `github.com/coldsmirk/vef-framework-go/security`，有各自的 `ErrCodeXxx` 常量。认证错误使用 `1000-1024`；challenge 错误预留 `1030-1039`，当前实际导出 `1031`、`1033-1038`；密码策略违规共用一个错误码 `1050`（完整的密码规则与锁定错误目录见 [登录加固](../security/login-hardening)）。

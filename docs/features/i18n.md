...
This page has been checked against the live Go source and the generated public API index.

| Package | Reviewed surface |
| --- | --- |
| `github.com/coldsmirk/vef-framework-go/i18n` | 12 top-level exported symbols, 1 exported field, and 2 exported methods. The public surface fingerprint is `67076d160fa9ebb52302f2873faebeb52fd2be12e1386f8f2825b01130da74ae`. |
| `github.com/coldsmirk/vef-framework-go/i18n/locales` | 1 top-level exported symbol, 0 exported fields, and 0 exported methods. The public surface fingerprint is `71bc852d645cd378f46663e5998b7e22b9c7372906fdaf6a04ded7acc122ade0`. |
...
`i18n.GetSupportedLanguages()` returns a copy of the supported-language slice, so modifying the returned slice does not mutate framework state. The current shipped `en.json` and `zh-CN.json` catalogs contain the same 171 message IDs.

...
The MCP package audit currently locks **119 public MCP entries** in the
generated API ledger. The grouped member surface covers **75 grouped MCP
field/method entries** across **27 MCP receiver/type families**: **11 exported
MCP field entries** and **64 exported MCP method entries**. The generated public
API index remains the complete signature list.

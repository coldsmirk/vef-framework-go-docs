...
func main() {
	...
	if got := constValues["VEFVersion"]; got != "v0.51.0" {
		failures = append(failures, fmt.Sprintf("VEFVersion value drifted: got %q, want %q", got, "v0.51.0"))
	}

...
var eventPackages = []eventPackage{
	...
	},
	{
		...
		methods:     7,
		entries:     17,
		fingerprint: "6843fdec1f7a06d08d3097e6af2fbf21979f10f99513e7745e466759ffc21668",
	...
	checks := []struct {
		...
		},
		{
			...
			sourceTerms: []string{
				...
				"ConsumerID string", "StartID string", "EffectiveStreamPrefix",
			...
			docTerms: []string{
				...
				"ClaimIdle", "ClaimInterval", "ClaimBatchSize", "ConsumerID",
				"StartID", "stream_prefix", "max_len_approx", "block_timeout",
				"claim_idle", "claim_interval", "claim_batch_size",
				"consumer_id", "start_id", "vef:events:", "`0`",
			},
		},
		{

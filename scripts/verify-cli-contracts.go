...
var cliPackages = []cliPackage{
	...
	{
		pkg:         "github.com/coldsmirk/vef-framework-go/cmd/vef-cli/cmd/exportapi",
		topLevel:    4,
		fields:      0,
		methods:     0,
		entries:     4,
		fingerprint: "9106bab9d3d0b33ebbe20adaeace19128c108eba247f076386eeb8f3fe839171",
		contractID:  "github.com/coldsmirk/vef-framework-go/cmd/vef-cli/cmd/exportapi#command-contract:api-manifest-export",
	},
	{
		pkg:         "github.com/coldsmirk/vef-framework-go/cmd/vef-cli/cmd/scaffold",
		topLevel:    24,
		fields:      54,
		methods:     13,
		entries:     91,
		fingerprint: "81bc66a92daa9a50462f2e19a3fb525cc145fb0d937e5950e3bb100d84e103d0",
		contractID:  "github.com/coldsmirk/vef-framework-go/cmd/vef-cli/cmd/scaffold#command-contract:code-scaffolding",
	},
	{
...
func verifySourceContracts(sourceRoot string) []string {
	files := map[string]string{
		...
		"cmd/vef-cli/cmd/scaffold/command.go":           readSourceFile(sourceRoot, "cmd/vef-cli/cmd/scaffold/command.go").content,
		"cmd/vef-cli/cmd/scaffold/project.go":           readSourceFile(sourceRoot, "cmd/vef-cli/cmd/scaffold/project.go").content,
		"cmd/vef-cli/cmd/exportapi/command.go":          readSourceFile(sourceRoot, "cmd/vef-cli/cmd/exportapi/command.go").content,
	...
	checks := []struct {
		...
		{"cmd/vef-cli/cmd/root.go", "scaffold.Command()"},
		{"cmd/vef-cli/cmd/root.go", "exportapi.Command()"},
		...
		{"cmd/vef-cli/cmd/scaffold/command.go", `Use:   "new"`},
		{"cmd/vef-cli/cmd/scaffold/command.go", "cmd.AddCommand(resourceCommand(), serviceCommand(), projectCommand())"},
		{"cmd/vef-cli/cmd/scaffold/command.go", `cmd.Flags().StringP("table", "t", "", "Database table to derive the entity from (required)")`},
		{"cmd/vef-cli/cmd/scaffold/command.go", `cmd.Flags().StringSlice("search", nil,`},
		{"cmd/vef-cli/cmd/scaffold/command.go", `cmd.Flags().StringSlice("deps", nil,`},
		{"cmd/vef-cli/cmd/scaffold/command.go", `_ = cmd.MarkFlagRequired("table")`},
		{"cmd/vef-cli/cmd/scaffold/project.go", `Use:   "project <name>"`},
		{"cmd/vef-cli/cmd/scaffold/project.go", `cmd.Flags().Bool("with-example", true,`},
		{"cmd/vef-cli/cmd/exportapi/command.go", `Use:   "export-api"`},
		{"cmd/vef-cli/cmd/exportapi/command.go", `cmd.Flags().String("app", "./cmd/server"`},
		{"cmd/vef-cli/cmd/exportapi/command.go", `cmd.Flags().StringP("output", "o", "api-manifest.json"`},
		{"cmd/vef-cli/cmd/exportapi/command.go", `cmd.Flags().Bool("check", false`},
		{"cmd/vef-cli/cmd/exportapi/command.go", "ErrCheckNeedsAFile"},
		{"cmd/vef-cli/cmd/exportapi/command.go", "ErrManifestOutdated"},
